...
def push_as_commit(base_path, path, name, branch, ticket):
...
def download_crowdin(base_path, branch, xml, config, ticket):
    if config:
    ...
    for path in paths:
        ...
        for project in items:
            ...
            push_as_commit(base_path, result,
                           project.getAttribute('name'), br, ticket)
            break
...
def main():
    ...
    if 'stable/' in default_branch:
        base_path_env = 'NAMELESS_CROWDIN_STABLE_BASE_PATH'
